...
export const createProduct = (name: string, unitsInStock: number, priority: ProductPriority, createdDate: string) => action(ActionTypes.CREATE_PRODUCT, { name, unitsInStock, priority, createdDate });
